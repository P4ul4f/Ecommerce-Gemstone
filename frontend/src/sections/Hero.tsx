  ...
  return (
    ...
    >
      ...
      <div className="container relative mt-16 px-4">
        <h1 className="text-5xl sm:text-7xl md:text-[158px] leading-none font-semibold tracking-tighter bg-white bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,.5))] text-transparent bg-clip-text text-center">
          Luxury Gemstone{" "}
        </h1>
        <p className="text-lg md:text-xl text-white/70 mt-5 text-center max-w-xl mx-auto">
          Experience the allure of nature`s finest treasures.
        </p>
